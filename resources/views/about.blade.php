@extends('layout')
@section('title') About Us for Kelvin Site @endsection
...
THE KELVIN SITE STORY</h3>
<p class="white-text" style="font-weight:bold;">    JOURNEY OF KELVIN SITE FROM IDEATION TO STARTUP</p>
